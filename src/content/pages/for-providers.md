...
Consider referral for any patient with bothersome BPH/LUTS who would benefit from a surgical opinion — particularly:

- **Medication failure or intolerance** — symptoms not controlled on an alpha-blocker and/or 5-ARI, or side effects the patient doesn't want to continue accepting.
- **Large prostates** — glands above ~80 mL, where HoLEP is size-independent and outperforms options with size ceilings.
- **Urinary retention** — acute or chronic, including catheter-dependent patients and those who have failed trials without catheter.
- **Patients told they are "not surgical candidates"** elsewhere because of prostate size, age, comorbidity, or anticoagulation — HoLEP's bleeding profile and size range make many of these patients candidates.
- **Recurrent gross hematuria, bladder stones, or recurrent UTI** attributable to bladder outlet obstruction.
- **Failed prior procedures** — UroLift, Rezum, GreenLight PVP, or prior TURP that didn't deliver durable relief.

Dr. Quarrier also accepts referrals for **complex stone disease** (PCNL, ureteroscopy).

## What HoLEP offers your patient

HoLEP is size-independent, has the lowest retreatment rate of the major BPH procedures, has a favorable bleeding profile (often performed without stopping anticoagulation), and most patients go home the same day. See the [comparison page](/why-holep) for the evidence behind each of those points.
...
- Recent IPSS or a description of symptom burden
- PSA with date
- Any prior prostate imaging (TRUS or MRI) and prostate volume
- Post-void residual or uroflow if measured
